...
国内vps等加`https://mirror.ghproxy.com/`  
> 示例
```
...
```
ql repo https://mirror.ghproxy.com/https://github.com/monk-coder/dust.git "i-chenzhe|normal|member|car" "backup"
```

```
ql repo https://mirror.ghproxy.com/https://github.com/nianyuguai/longzhuzhu.git "qx"
```
...
- 拉取自定义仓库
``` sh
docker exec -it qinglong ql repo https://mirror.ghproxy.com/https://github.com/whyour/hundun.git "quanx" "tokens|caiyun|didi|donate|fold|Env"
```

- 拉取单个脚本
``` sh
docker exec -it qinglong ql raw https://mirror.ghproxy.com/https://raw.githubusercontent.com/moposmall/Script/main/Me/jx_cfd.js
```
