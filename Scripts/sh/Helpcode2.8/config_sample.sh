...
## 2、清空购物车
### 使用前请认真看对应注释：https://mirror.ghproxy.com/X1a0He/jd_scripts_fixed/main/jd_cart_remove.js
...
### 使用前请认真看对应注释：https://mirror.ghproxy.com/X1a0He/jd_scripts_fixed/main/jd_try_xh.js
export JD_TRY="true"
...
## 4、批量取关店铺和商品
### 是否执行取消关注，默认true
### 使用前请认真看对应注释：https://mirror.ghproxy.com/X1a0He/jd_scripts_fixed/main/jd_unsubscribe_xh.js
